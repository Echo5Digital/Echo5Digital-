...
import { WordStagger, CountUp, ParallaxImage } from "@/components/ScrollFX";
import {
  Factory,
  Search,
  FileText,
...
const industryStudies = [
  {
    ...
    stat: 46,
    detail: "Of all Google searches are seeking local information, making local SEO critical for manufacturers targeting regional clients.",
    source: "HubSpot",
  },
  {
    number: "02",
    title: "B2B Research Online",
    stat: 89,
    detail: "Of B2B researchers use the internet during their research process, underscoring the need for strong online visibility.",
    source: "Google",
  },
  {
    number: "03",
    title: "B2B Researchers Start with Generic Searches",
    stat: 71,
    detail: "Of B2B researchers start their research with a generic search, making broad keyword visibility essential.",
    source: "Google",
  },
];
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              <span className="text-xs font-bold" style={{ color: "#C4A0FA" }}>
                {strategyPillars[activeIndex].number} / 09
              </span>
...
export default function ManufacturingIndustrialClient({ faqData }: Props) {
    ...
    <main style={{ backgroundColor: "#0A0F1E", color: "#E5E7EB", fontFamily: "Inter, sans-serif" }}>
      ...
      <section ref={heroRef} className="relative overflow-hidden" style={{ background: "linear-gradient(135deg, #0A0F1E 0%, #110D2E 50%, #0A0F1E 100%)" }}>
        <div className="absolute inset-0">
          <motion.div className="absolute inset-0" style={{ y: heroImageY, scale: heroImageScale }}>
            <Image
              src="https://images.pexels.com/photos/236698/pexels-photo-236698.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=900&w=1600"
              alt="Industrial manufacturing facility floor"
              fill
              priority
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 text-center">
          ...
          >
            <WordStagger text="Industrial SEO Built to" delay={0.1} />{" "}
            <span
              style={{
            ...
            >
              <WordStagger text="Propel Your Business" delay={0.5} className="inline" />
            </span>
          </h1>

          <Reveal variant="up" delay={0.2}>
            <p className="text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed" style={{ color: "rgba(229,231,235,0.75)" }}>
              Manufacturing and industrial sectors require specialized online
              strategies. Echo5 Digital offers tailored SEO services to help
              these businesses enhance search rankings, generate qualified
              B2B leads, and expand market reach.
            </p>
          </Reveal>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ background: "#0F1629" }}>
        <div className="max-w-4xl mx-auto text-center">
          <Reveal variant="zoom">
            <Factory size={36} style={{ color: "#A855F7", margin: "0 auto 1.5rem" }} />
          </Reveal>
          ...
          <Reveal variant="up" delay={0.2}>
            <p className="text-base md:text-lg leading-relaxed" style={{ color: "rgba(229,231,235,0.7)" }}>
              70% of industrial buyers prefer to work with suppliers who have
              a strong online presence, making digital visibility a critical
              competitive advantage in the manufacturing and industrial
              sectors.
            </p>
          </Reveal>
        </div>
      ...
      {/* ═══════════════════════ SERVICE OFFERINGS — STICKY IMAGE + SCROLL ═══════════════════════ */}
        ...
        <div className="max-w-6xl mx-auto">
          <Reveal variant="up" className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-black mb-4 leading-tight" style={{ fontFamily: "Space Grotesk, sans-serif", color: "#E5E7EB" }}>
              Manufacturing &amp; Industrial SEO Strategy
            </h2>
            <p className="text-base max-w-2xl mx-auto" style={{ color: "rgba(229,231,235,0.6)" }}>
              A full-funnel approach built around how industrial buyers research, evaluate, and choose suppliers.
            </p>
          </Reveal>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <Reveal variant="up">
            ...
            <p className="text-base mb-8" style={{ color: "rgba(229,231,235,0.7)" }}>
              Contact Echo5 Digital today to learn how our targeted SEO strategies can help your manufacturing or industrial business grow.
            </p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-bold text-base text-white transition-all duration-200 hover:brightness-110 hover:scale-105"
          ...
          <Reveal variant="left">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-black mb-5 leading-tight" style={{ fontFamily: "Space Grotesk, sans-serif", color: "#E5E7EB" }}>
                A Strong Online Presence Wins the Buyer
              </h2>
              <p className="text-base leading-relaxed mb-4" style={{ color: "rgba(229,231,235,0.7)" }}>
                Higher search rankings make it easier for potential B2B
                clients to find you, increasing website traffic and
                qualified leads.
              </p>
              <p className="text-base leading-relaxed" style={{ color: "rgba(229,231,235,0.7)" }}>
                At Echo5 Digital, we combine keyword research, content
                optimization, technical SEO, and ongoing analysis to help
                manufacturers and industrial businesses grow their online
                visibility and market reach.
              </p>
            </div>
          </Reveal>
          <ParallaxImage
            src="https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=700&w=940"
            alt="Engineer reviewing production data on a tablet in a factory"
          ...
          <Reveal variant="left">
            <div>
              ...
              <p className="text-base leading-relaxed mb-8" style={{ color: "rgba(229,231,235,0.7)" }}>
                ...
                manufacturing and industrial-specific SEO strategy can build
                trust and attract more of the right B2B buyers.
              </p>
              <div className="flex flex-col gap-3">
