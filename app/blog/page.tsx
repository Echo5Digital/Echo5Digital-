    ...
    <>
      ...
      <Section background="elevated" spacing="sm" withDivider>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#E5E7EB", fontFamily: "Inter, sans-serif" }}>
      ...
      <Section background="elevated" spacing="md" withDivider>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-base leading-relaxed mb-6" style={{ color: "rgba(229,231,235,0.7)", fontFamily: "Inter, sans-serif" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm" style={{ color: "rgba(229,231,235,0.5)", fontFamily: "Inter, sans-serif" }}>
            <span className="flex items-center gap-2">
              {/* Phone — verified fact */}
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#A855F7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 8.81a19.79 19.79 0 01-3.07-8.63A2 2 0 012 .18h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
              {/* verified phone */}
              <a href="tel:7134897004" style={{ color: "rgba(229,231,235,0.5)" }}>713-489-7004</a>
            </span>
            <span className="flex items-center gap-2">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#A855F7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
              <a href="mailto:hello@echo5digital.com" style={{ color: "rgba(229,231,235,0.5)" }}>hello@echo5digital.com</a>
            </span>
            <span className="flex items-center gap-2">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#A855F7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
