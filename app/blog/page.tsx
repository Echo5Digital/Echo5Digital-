        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm" style={{ color: "rgba(31,35,64,0.6)", fontFamily: "Inter, sans-serif" }}>
            <span className="flex items-center gap-2">
              ...
              {/* verified phone */}
              <a href="tel:+17134897004" style={{ color: "rgba(31,35,64,0.6)" }}>713-489-7004</a>
            </span>
            <span className="flex items-center gap-2">
              ...
              <a href="mailto:sales@echo5digital.com" style={{ color: "rgba(31,35,64,0.6)" }}>sales@echo5digital.com</a>
            </span>
            <span className="flex items-center gap-2">
